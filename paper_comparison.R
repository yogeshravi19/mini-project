...
# R Script — ggplot2 Visualizations
# Run: source("d:/MINI PROJECT/paper_comparison.R")
...
theme_dark_paper <- function() {
  theme_minimal() +
    theme(
      ...
      plot.title        = element_text(color = "#f0f6fc", size = 13, face = "bold", hjust = 0),
